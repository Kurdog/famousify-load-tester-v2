...
class LoadTesterGUI:
    ...
    def setup_config_tab(self, notebook):
        ...
        self.url_entry.insert(0, "https://famousify-production.up.railway.app")
    ...
    def setup_run_tab(self, notebook):
        ...
        # Custom combobox style for dark theme
        style = ttk.Style()
        style.map('TCombobox', 
...
TEEINBLUE Pipeline ($0.08253/gen):
  • AI Generation (FLUX Kontext Max): $0.08000
...
USER Pipeline:
  • 10 requests:  $0.88 (base) → $0.97 (con margin 10%)
  • 50 requests:  $4.40 → $4.84
  • 100 requests: $8.80 → $9.68

TEEINBLUE Pipeline:
  • 10 requests:  $0.83 → $0.91
  • 50 requests:  $4.13 → $4.54
  • 100 requests: $8.25 → $9.08
...
Il log mostra in tempo reale:
  • Submission delle richieste
  • Completamento job
  • Errori eventuali
...
✓ Monitora success rate nel report
